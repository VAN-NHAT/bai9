...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Trần Văn Nhật");
        ...
        arr_bean.add(new ListViewBean(R.drawable.t, "Thái Lan","Diện tích 685.321km2, Dân số 112 Tr người"));
        arr_bean.add(new ListViewBean(R.drawable.p, "Pháp","Diện tích 685.321km2, Dân số 112 Tr người"));
        arr_bean.add(new ListViewBean(R.drawable.e,"Vương Quốc Anh","Diện tích 685.321km2, Dân số 112 Tr người"));
        arr_bean.add(new ListViewBean(R.drawable.v, "Việt Nam","Diện tích 685.321km2, Dân số 112 Tr người"));
        arr_bean.add(new ListViewBean(R.drawable.d, "Đức","Diện tích 685.321km2, Dân số 112 Tr người"));
        arr_bean.add(new ListViewBean(R.drawable.a, "Ấn Độ","Diện tích 685.321km2, Dân số 112 Tr người"));
